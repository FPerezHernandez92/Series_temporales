...
# Cargamos serie con estacionalidad
serie<-scan("ModeloAR2_estacionalidad_simulado.dat")
plot.ts(serie) # la mostramos
print("Mostrando la serie con estacionalidad")
...
print("La hipotesis de modelado lineal va bien.")
GuardarTendEstimada<- TendEstimada; # Guardamos la tendencia estimada para luego

# Hipótesis 2: Modelo cuadratico x= a + b*t +c*t^2 (x=serie; t=tiempo; a,b,c=parámetros a estimar)
tiempo<- 1:length(serie) # Creamos la variable que modela al tiempo
...
matplot(series, pch=1, type= "l")
print("Metodo de eliminacion de tendencia por aproximacion funcional.")
print("La hipotesis de modelado polinomico de 2o. grado parece que va peor que la lineal.")
TendEstimada<-GuardarTendEstimada;
...
print("Mostrando el ACF de la serie sin tendencia con el método de filtrado. Parece que hay estacionalidad...")

...
# Cargamos serie con tendencia
serie<-scan("ModeloAR2_tendencia_simulado.dat")
print("Mostrando la serie con tendencia")
...
print("La hipotesis de modelado lineal es valida.")
